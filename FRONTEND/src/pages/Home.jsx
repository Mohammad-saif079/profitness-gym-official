    ...
    <div className='  w-[100vw] h-[100svh] relative bg-[#0B0B0F]   flex items-center justify-center '>
      <div className='absolute top-7 flex flex-col justify-center items-center gap-2 sm:gap-0 ' >
        ...
        <div className=' overflow-hidden sm:w-[600px] w-[90vw] flex flex-col justify-center '>
          <h1 className='  sm:w-[full] w-[90vw] font-semibold mx-0 my-1 text-white text-3xl '>LOGIN GYM ACCOUNT</h1>

          <Input title="Username* OR Email*" placeholder="Username OR Email" error={err2} herovalue={username} setherovalue={setusername} />
          <Input title="Password*" ispassword={true} placeholder="Password" error={err3} herovalue={password} setherovalue={setpassword} />
          <button onClick={handleLogin} className=' sm:w-[580px] overflow-hidden flex justify-center items-center rounded-[10px] py-3 text-[18px] w-full bg-[#b22222] text-[#fff] font-semibold ' >
            {loading ? (
          ...
          <button className=' sm:w-[580px] overflow-hidden flex justify-center items-center rounded-[10px] py-2 text-[18px] w-full gap-2 text-[#fff] font-semibold border-2 ' >
            <svg
              width={33}
